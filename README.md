...
Therefore, only by simultaneously constraining the perturbation magnitude with $\mathcal{L}_{\mathrm{noise}}$ and preserving the semantic structure with $\mathcal{L}_{lpips}$ can stealthiness be guaranteed.
